 ...
 * method, our observers will stand ready to execute a wide variety of actions based on
 * updates from the Subject class, from Graphical User Interface changes to telling the rest of the team on Slack of any problems.
 */
