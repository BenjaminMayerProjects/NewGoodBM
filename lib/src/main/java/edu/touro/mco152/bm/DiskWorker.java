...
public class DiskWorker implements Callable {
    ...
    public Object call() throws Exception {
        ...
        if (App.writeTest) {
             ...
             */
            for (int m = startFileNum; m < startFileNum + App.numOfMarks && !UI.isCancelledUI(); m++) {
                ...
                try {
                    try (RandomAccessFile rAccFile = new RandomAccessFile(testFile, mode)) {
                        for (int b = 0; b < numOfBlocks; b++) {
                             ...
                             */
                            UI.setProgressUI((int) percentComplete);
                        }
                    }
        ...
        if (App.readTest && App.writeTest && !UI.isCancelledUI()) {
    ...
    public void setUI(BenchmarkUI UI) {
        this.UI = UI;
    }
}
